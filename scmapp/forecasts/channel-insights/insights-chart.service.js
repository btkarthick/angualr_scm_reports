...
(function() {
    ...
    var setChartService = function( vfr, REMOTECONTROLLER, ngForceConfig ) {
        ...
        var getDataForChannelInsights = function () {
            ...
            var getInsFunc = vfr.send(REMOTECONTROLLER + '.' + 'RetriveChartData', {}, false);
            
            return getInsFunc( ngForceConfig.selectedGroupID ).then(function(response) {

                objChartsData = response;
    ...
    setChartService.$inject = [  'vfr', 'REMOTECONTROLLER', 'ngForceConfig' ];
})();